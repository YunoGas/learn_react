...
const Navbar = (props) => {
    ...
    return (
        ...
        <nav className={css.nav}>
            <div className={`${css.item}`}><NavLink className={css.itemLink} to="/profile" activeClassName={css.active}>PROFILE</NavLink></div>
            <div className={css.item}><NavLink className={css.itemLink} to="/dialogs" activeClassName={css.active}>MESSAGES</NavLink></div>
